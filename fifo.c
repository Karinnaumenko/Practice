...
int main() {
	...
	size_t size;
	char resstring[13];
	//Создаем символьный массив, где будет храниться файл ФИФО
	char name[] = "fifo.fifo";
	//После первого запуска программы необходимо закомментировать процесс создания  файла ФИФО
...
*/
	...
	//процесс= родитель пишет тнформацию в ФИФО
	else if (result > 0) {
	...
	// процесс - ребенок читает информацию из ФИФО
	else {
